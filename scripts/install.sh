...
echo ""
echo "Quick start:"
echo "  /vmx-start-dev     - Begin development work"
echo "  /vmx-dev-cycle     - Self-review + peer review iteration"
echo "  /vmx-quick-pr      - Create a pull request"
echo "  /vmx-make-release  - Prepare and deploy release"

...
**Adopting for your team?** See the [Adoption Guide](docs/adoption-guide.md) for team-size-specific paths.

**Not using Claude Code?** See [Using With Other Tools](docs/using-with-other-tools.md) for adaptation guides.
...
See [Workflows](docs/workflows.md) for the full picture, or [Recipes](docs/recipes.md) for real-world examples.
...
The [Integration Guide](docs/integration-guide.md) shows how commands compose into workflows.
